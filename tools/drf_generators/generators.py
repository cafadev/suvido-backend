...
from tools.drf_generators.templates.serializer import SERIALIZER
from tools.drf_generators.templates.apiview import API_URL, API_VIEW
from tools.drf_generators.templates.viewset import VIEW_SET_URL, VIEW_SET_VIEW
from tools.drf_generators.templates.function import FUNCTION_URL, FUNCTION_VIEW
from tools.drf_generators.templates.modelviewset import MODEL_URL, MODEL_VIEW
...
class BaseGenerator(object):
    ...
    def url_content(self):
        context = Context({'app': self.name, 'models': ['User'] + self.models})
